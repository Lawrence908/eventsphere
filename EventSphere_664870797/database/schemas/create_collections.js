            ...
            properties: {
                ...
                hybridDetails: {
                    ...
                    properties: {
                        ...
                        virtualMeetingUrl: { bsonType: ["string", "null"] }
                    }
                },
                metadata: {
                    bsonType: ["object", "null"],
        ...
        $jsonSchema: {
            ...
            properties: {
                ...
                pricing: {
                    bsonType: ["object", "null"],
                    properties: { 
                        hourlyRate: { bsonType: ["double", "int", "long", "null"], minimum: 0 }, 
                        dailyRate: { bsonType: ["double", "int", "long", "null"], minimum: 0 }, 
                        currency: { bsonType: ["string", "null"] } 
                    }
                },
            ...
            properties: {
                ...
                metadata: { 
                    ...
                    properties: { 
                        ...
                        staffVerified: { bsonType: ["bool", "null"] } 
                    } 
                },
                createdAt: { bsonType: "date" },
                updatedAt: { bsonType: ["date", "null"] }
